# Write a function called `choose_func` which takes
# a list of nums and 2 callback functions.
# If all nums inside the list are positive,
# execute the first function on that list
# and return the result of it. Otherwise,
