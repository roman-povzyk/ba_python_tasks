...
# which you have done during the course, and annotate
# this code with type hints, using knowledge from this lesson.
...
def search_by_fullname():
    ...
    search_first_last_names: str = get_word_from_user()
    find_first_last_names: int = 0
...
def edit_contact():
    ...
    if search_if_phone_exist(search_for_change_phone):
        ...
        change_first_name: str = get_word_from_user()
        change_last_name: str = get_word_from_user()
        change_city: str = get_word_from_user()

        for phone, contact in data_json.items():
            if search_for_change_phone == phone:
                contact['first_name']: str = change_first_name
                contact['last_name']: str = change_last_name
                contact['city']: str = change_city
